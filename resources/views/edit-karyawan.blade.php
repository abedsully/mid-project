...
<body>
    ...
    <form action="{{route('update', $karyawan->id)}}" method="POST" onsubmit="return validasi()">
        @csrf
        @method('patch')
        <div class="form-group">
          <label for="exampleInputEmail1">Nama</label>
          <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="Nama" value="{{$karyawan->Nama}}">
        </div>
        <div class="form-group">
          <label for="exampleInputPassword1">Umur</label>
          <input type="number" class="form-control" id="exampleInputPassword1" name="Umur" min="20" value="{{$karyawan->Umur}}">
        </div>

        <div class="form-group">
            <label for="exampleInputEmail1">Alamat</label>
            <input type="text" class="form-control" id="exampleInputEmail2" aria-describedby="emailHelp" name="Alamat" value="{{$karyawan->Alamat}}">
          </div>
          <div class="form-group">
            <label for="exampleInputPassword1">Telepon</label>
            <input type="tel" class="form-control" id="exampleInputPassword2"  name="Telepon" pattern="08[1-9][0-9]{9,12}$" value="{{$karyawan->Telepon}}">
          </div>
